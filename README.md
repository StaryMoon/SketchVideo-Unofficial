...
[Paper](https://openaccess.thecvf.com/content/CVPR2025/html/Liu_SketchVideo_Sketch-based_Video_Generation_and_Editing_CVPR_2025_paper.html) · [PDF](https://openaccess.thecvf.com/content/CVPR2025/papers/Liu_SketchVideo_Sketch-based_Video_Generation_and_Editing_CVPR_2025_paper.pdf) · [Issues](https://github.com/StaryMoon/SketchVideo-Unofficial/issues) · [Release](https://github.com/StaryMoon/SketchVideo-Unofficial/releases)
...
<p align="center">
  <img src="assets/paper-preview.png" alt="SketchVideo-Unofficial paper or project page preview" width="900">
</p>

<sub>Image source: public paper/project page screenshot, [Paper](https://openaccess.thecvf.com/content/CVPR2025/html/Liu_SketchVideo_Sketch-based_Video_Generation_and_Editing_CVPR_2025_paper.html). Captured/organized on 2026-07-02. This repository is unofficial and is not affiliated with the paper authors.</sub>

## At a Glance

| Item | Details |
|---|---|
| Paper | SketchVideo: Sketch-based Video Generation and Editing |
| Venue / Source | CVPR 2025 |
| Focus | This repository organizes a PyTorch implementation for SketchVideo: Sketch-based Video Generation and Editing, focusing on sketch-based video generation and editing. The codebas... |
...
```python
import torch
from sketchvideo_unofficial import ModelConfig, UnofficialModel, reconstruction_loss
...
```python
import torch
from sketchvideo_unofficial import UnofficialModel
...
|---|---|---|
| Main quantitative comparison | Main paper tables, pp. 23379-23390 | [CVF paper page](https://openaccess.thecvf.com/content/CVPR2025/html/Liu_SketchVideo_Sketch-based_Video_Generation_and_Editing_CVPR_2025_paper.html) |
| Ablation study | Ablation / experiment section | [CVF paper page](https://openaccess.thecvf.com/content/CVPR2025/html/Liu_SketchVideo_Sketch-based_Video_Generation_and_Editing_CVPR_2025_paper.html) |
| Qualitative examples | Main paper figures and supplemental material | [CVF paper page](https://openaccess.thecvf.com/content/CVPR2025/html/Liu_SketchVideo_Sketch-based_Video_Generation_and_Editing_CVPR_2025_paper.html) |
...
- Thanks to the authors of **SketchVideo: Sketch-based Video Generation and Editing** for the original research.
...
cvpr-2025, pytorch, unofficial-implementation, video-generation, video-editing, sketch-guided-generation
